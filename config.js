...
global.sudo = process.env.SUDO || "94715722763,94702722766,94764246070,94742817784";
global.owner = process.env.OWNER_NUMBER || "94702722766,94764246070";
...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME || "𝐒𝐀𝐂𝐇𝐈𝐍.𝐌𝐃",
